...
const App = () => {
  return (
    <div>
      <Navbar />
      <Container>
        <boxStylesFull background={background}>
      ...
      <Container>
        <boxStylesSmall background={"var(--orange-100)"}>
          <div>
          ...
          <img
            className={boxStylesStyle.image}
            src={image1}
            style={{ width: "70%", marginStylesLeft: "20%", position: "absolute" }}
            alt=""
          />
        </boxStylesSmall>
        <boxStylesSmall background={"linear-gradient(135deg ,#ff0069, #ff7f00)"}>
          <div>
        ...
        <boxStylesSmall background={"var(--purple-100)"}>
          <div>
      ...
      <Container>
        <boxStylesMedium background={image3}></boxStylesMedium>
        <boxStylesSmall background={"linear-gradient(45deg, #ff00f6 -200%, #00ffcc, #46ff00 200%)"}></boxStylesSmall>
      </Container>
      <Bottombar />
    </div>
  );
