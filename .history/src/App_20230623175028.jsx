    ...
    <div>
      ...
      <Container>
        <BoxFull background={background}>
          <div className={[Text.text36, app.gra].join(" ")}>Creative plans. Designed for you.</div>
          <div className={Margin.block2rem}></div>
          <div className={Text.text20}>Explore video, photo, design, and more with a Creative Cloud plan that works for you.</div>
