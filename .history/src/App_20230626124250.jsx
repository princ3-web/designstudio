    ...
    <div>
      ...
      <Container>
        <BoxSmall background={"var(--orange-100)"}>
          ...
          <div className={Text.text20}>Recolor your world.</div>
          <div className={Text.text20}>With simple text prompts and Generative Recolor (beta), unlock endless color combinations in seconds. Dream Bigger.</div>
          <img className={BoxStyle.image} src={image1} style={{ width: "60%" }} alt="" />
        </BoxSmall>
