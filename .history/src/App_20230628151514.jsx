    ...
    <div>
      ...
      <Container>
        ...
        <BoxSmall background={"linear-gradient(135deg ,#ff0069, #ff7f00)"}>
          <div>
            ...
            <div className={[textStyles.text16, marginStyles.block1rem].join(" ")} style={{ color: "var(--gray-100)" }}>
              Flyers. TikToks. Reels. Create easier. Dream Bigger. With Adobe Firefly generative AI and the new Adobe
              Express.
            </div>
            <div className={textStyles.text16} style={{ color: "var(--gray-100)" }}>
              Join the free beta
            </div>
          </div>
          <img
      ...
      <Container>
        <BoxMedium background={image2}>
          <div>
            <div className={textStyles.text24}>
              Level up with Adobe Express.
            </div>
            <div className={[textStyles.text16, marginStyles.block1rem, textStyles.dark].join(" ")}>
              Flyers. TikToks. Reels. Create easier. Dream Bigger. With Adobe Firefly generative AI and the new Adobe
              Express.
            </div>
          </div>
        </BoxMedium>
        <BoxSmall background={"linear-gradient(45deg, #ff00f6 -200%, #00ffcc, #46ff00 200%)"}>
          <div>
            <div className={[textStyles.text24, textStyles.dark].join(" ")}>
              Level up with Adobe Express.
            </div>
