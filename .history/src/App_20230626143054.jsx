...
import marginStyles.Styles from "./css/marginStyles..module.css";
      ...
      <Container>
        <BoxSmall background={"var(--orange-100)"}>
          ...
          <img
            ...
            src={image1}
            style={{ width: "70%", marginStyles.Left: "20%", position: "absolute" }}
            alt=""
          />
        </BoxSmall>
        <BoxSmall background={"linear-gradient(135deg ,#ff0069, #ff7f00)"}>
          ...
          <img
            className={BoxStyle.image}
            src={image0}
            style={{ width: "36%", marginStyles.Left: "55%", position: "absolute" }}
            alt=""
          />
        </BoxSmall>
