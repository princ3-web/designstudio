...
const links = [
  ...
  {
    category: "Support",
    elements: ["Download and install", "Help Center", "Adobe Support Community", "Enterprise Support", "Genuine software"],
  },
    ...
    <div className={bottombarStyles.bottombar}>
      {links.map((item) => (
        <div className={bottombarStyles.column}>
          ...
          {item.elements.map(item => <div className={bottombarStyles.item}>item</div>)}
        </div>
      ))}
    </div>
  );
