    ...
    <div className={bottombarStyles.bottombar}>
      {links.map((item) => (
        <div className={bottombarStyles.column}>
          <div className={[bottombarStyles.category, textStyles.bold, marginStyles.bottom1rem, textStyles.text14].join(" ")}>
            {item.category}
          </div>
          {item.elements.map((i) => (
            <div className={[bottombarStyles.elemen, textStyles.text12].join(" ")}>{i}</div>
          ))}
        </div>
      ))}
    </div>
