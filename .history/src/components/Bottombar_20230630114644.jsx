...
import tiktok from "../assets/icons/instagram.png";
import youtube from "../assets/icons/instagram.png";
  ...
  return (
    <div className={bottombarStyles.bottombar}>
      ...
      <div className={bottombarStyles.socialLinks}>
        <div className={bottombarStyles.socialTitle}>Reach us on social media</div>
        {socialMedia.map((object) => (
          <div className={bottombarStyles.socialItem}>{object.name}</div>
        ))}
      </div>
    </div>
  );
