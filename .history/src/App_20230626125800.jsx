    ...
    <div>
      ...
      <Container>
        ...
        <BoxSmall background={"var(--pink-100)"}>
           <div className={Text.text24}>Level up with Adobe Express.</div>
           <div className={Text.text24}>Flyers. TikToks. Reels. Create easier. Dream Bigger. With Adobe Firefly generative AI and the new Adobe Express.</div>
           <div className={Text.text24}>Join the free beta</div>
          <img
            className={BoxStyle.image}
            src={image0}
            style={{ width: "40%", marginInline: "30%" }}
            alt=""
          />
        </BoxSmall>
