    ...
    <div>
      ...
      <Container>
        ...
        <BoxSmall background={"var(--pink-100)"}>
           <div style={{color: "var(--orange-100)"}} className={[Text.text24].join(" ")}>Level up with Adobe Express.</div>
           <div className={[Text.text20].join(" ")}>Flyers. TikToks. Reels. Create easier. Dream Bigger. With Adobe Firefly generative AI and the new Adobe Express.</div>
           <div className={[Text.text20].join(" ")}>Join the free beta</div>
          <img
            className={BoxStyle.image}
            src={image0}
