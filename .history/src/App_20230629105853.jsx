  ...
  return (
    <div>
      ...
      <Container>
        <BoxSmall background={"linear-gradient(45deg, #ff00f6 -60%, #00ffcc, #46ff00 200%)"}>
          <div>
            <div className={[textStyles.text24, textStyles.dark].join(" ")}>ACROBAT READER MOBILE APP</div>
            <div className={[textStyles.text16, marginStyles.block1rem].join(" ")}>Work now works wherever.</div>
            <div className={[textStyles.text16, marginStyles.block1rem].join(" ")}>
        ...
        <BoxSmall background={"linear-gradient(45deg, #ff00f6 -60%, #00ffcc, #46ff00 200%)"}>
          <div>
            <div className={[textStyles.text24, textStyles.dark].join(" ")}>ADOBE DOCUMENT CLOUD FOR BUSINESS</div>
            <div className={[textStyles.text16, marginStyles.block1rem].join(" ")}>PDFs keep work flowing.</div>
            <div className={[textStyles.text16, marginStyles.block1rem].join(" ")}>
