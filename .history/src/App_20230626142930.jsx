      ...
      <Container>
        <BoxSmall background={"var(--orange-100)"}>
          <div>
            ...
            <div className={[textStyles.text24, Margin.block1rem].join(" ")}>Recolor your world.</div>
          ...
          <img
            ...
            src={image1}
            style={{ width: "70%", marginLeft: "20%", position: "absolute" }}
            alt=""
          />
        </BoxSmall>
        <BoxSmall background={"linear-gradient(135deg ,#ff0069, #ff7f00)"}>
          <div>
            ...
            <div className={[textStyles.text18, Margin.block1rem].join(" ")} style={{ color: "var(--gray-100)" }}>
          ...
          <img
            className={BoxStyle.image}
            src={image0}
            style={{ width: "36%", marginLeft: "55%", position: "absolute" }}
            alt=""
          />
        </BoxSmall>
        <BoxSmall background={"var(--purple-100)"}>
          <div>
            ...
            <div className={[textStyles.text14, Margin.block1rem].join(" ")}>Creative Cloud All Apps free trial</div>
            <div className={[textStyles.text14, Margin.block1rem].join(" ")}>See plans and pricing</div>
            <div className={[textStyles.text18, textStyles.bold, textStyles.underline].join(" ")}>See what you can do</div>
            <div className={[textStyles.text14, Margin.block1rem].join(" ")}>Photography</div>
            <div className={[textStyles.text14, Margin.block1rem].join(" ")}>Graphic design</div>
            <div className={[textStyles.text14, Margin.block1rem].join(" ")}>Video</div>
            <div className={[textStyles.text14, Margin.block1rem].join(" ")}>Illustration</div>
            <div className={[textStyles.text14, Margin.block1rem].join(" ")}>UI and UX</div>
            <div className={[textStyles.text14, Margin.block1rem].join(" ")}>3D and AR</div>
          </div>
        </BoxSmall>
      </Container>
      <Container>
