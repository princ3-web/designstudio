...
import background4 from "../assets/images/background3.webp";
import background5 from "../assets/images/background3.webp";
  ...
  return (
    <div>
      <Container style={{ paddingInline: 0, height: "100vh" }}>
        <BoxFull backgroundImage={background2}>
      ...
      <Container>
        ...
        <BoxSmall background={"linear-gradient(135deg ,#ff0069, #ff7f00)"}>
          ...
          <img
            className={boxStyles.image}
            src={image3}
            style={{ width: "70%", right: "-5%", position: "absolute" }}
            alt=""
          />
        </BoxSmall>
      ...
      <Container>
        <BoxMedium background={background3}>
          <div>
      ...
      <Container style={{ paddingInline: 0, height: "100vh" }}>
        <BoxFull backgroundImage={background5}>
