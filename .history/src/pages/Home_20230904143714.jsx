...
const Home = () => {
  return (
    <div>
      <Container style={{ paddingInline: "0p", height: "100vh" }}>
      ...
      <Container>
        <BoxMedium background={background0}>
          <div>
      ...
      <Container style={{ paddingInline: 0, height: "100vh" }}>
        <BoxFull gradient={"linear-gradient(45deg, #00ff0d -60%, #ffbb00, #ff0000 200%)"} style={{height: "100%"}}>
