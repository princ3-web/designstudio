  ...
  <Container>
    ...
    <BoxSmall background={"var(--purple-100)"}>
      <div>
        ...
        <div className={[textStyles.text16, textStyles.bold, textStyles.underline].join(" ")}>See what you can do</div>
  ...
  <Container>
    ...
    <BoxSmall background={"linear-gradient(45deg, #d4ff00 -60%, #0099ff, #0077ff 200%)"}>
      <div>
        ...
        <div className={[textStyles.text16].join(" ")}>Unite remote teams with Adobe Document Cloud for business.</div>
      </div>
    </BoxSmall>
