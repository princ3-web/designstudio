  ...
  return (
    <div>
      <Container style={{ paddingInline: 0 }}>
        <BoxFull backgroundImage={"linear-gradient(45deg, #00aaff -60%, #ff6cc4ef, #f6ff00 200%)"}>
      ...
      <Container style={{ paddingInline: 0 }}>
        <BoxFull backgroundImage={"linear-gradient(45deg, #00ff0d -60%, #ffbb00, #ff0000 200%)"}>
      ...
      <Container style={{ paddingInline: 0 }}>
        <BoxFull backgroundImage={"linear-gradient(45deg, #c800ff -60%, #ff8400ef, #f6ff00 200%)"}>
