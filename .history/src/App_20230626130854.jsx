    ...
    <div>
      ...
      <Container>
        <BoxSmall background={"var(--orange-100)"}>
          <div>
            <div className={Text.text20}>NEW IN ILLUSTRATOR</div>
            <div className={Text.text24}>Recolor your world.</div>
            <div className={Text.text20}></div>
        ...
        <BoxSmall background={"var(--pink-100)"}>
           ...
           <div className={Text.text20} style={{color: "var(--gray-100)"}}>Flyers. TikToks. Reels. Create easier. Dream Bigger. With Adobe Firefly generative AI and the new Adobe Express.</div>
           <div className={Text.text20} style={{color: "var(--gray-100)"}}>Join the free beta</div>
          <img
            className={BoxStyle.image}
            src={image0}
        ...
        <BoxSmall background={"var(--purple-100)"}>
          <div className={[Text.text24, Text.underline].join(" ")}>Explore our creative apps</div>
        </BoxSmall>
      </Container>
      <Container>
        <BoxMedium></BoxMedium>
