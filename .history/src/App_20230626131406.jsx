      ...
      <Container>
        ...
        <BoxSmall background={"var(--purple-100)"}>
          <div>
            ...
            <div className={[Text.text16, Margin.block1rem].join(" ")}>See plans and pricing</div>
            <div className={[Text.text16, Text.underline].join(" ")}>
            See what you can do
            </div>
            <div className={[Text.text16, Margin.block1rem].join(" ")}>Photography</div>
            <div className={[Text.text16, Margin.block1rem].join(" ")}>Graphic design</div>
            <div className={[Text.text16, Margin.block1rem].join(" ")}>Video</div>
            <div className={[Text.text16, Margin.block1rem].join(" ")}>Illustration</div>
            <div className={[Text.text16, Margin.block1rem].join(" ")}>UI and UX</div>
            <div className={[Text.text16, Margin.block1rem].join(" ")}>3D and AR</div>
            <div className={[Text.text16, Margin.block1rem].join(" ")}>Social media</div>
          </div>
        </BoxSmall>
      </Container>
      <Container>
