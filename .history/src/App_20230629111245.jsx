    ...
    <div>
      ...
      <Container>
        <BoxSmall background={"var(--orange-100)"}>
          <div>
            ...
            <div className={[textStyles.text24, marginStyles.block1rem, textStyles.bold].join(" ")}>Recolor your world.</div>
        ...
        <BoxSmall background={"linear-gradient(135deg ,#ff0069, #ff7f00)"}>
          <div>
            <div className={[textStyles.text24, textStyles.light, textStyles.bold].join(" ")}>Level up with Adobe Express.</div>
      ...
      <Container>
        <BoxMedium background={image2}>
          <div>
            ...
            <div className={[textStyles.text16, textStyles.light, textStyles.bold].join(" ")}>
              Go to Premiere Pro
            </div>
          </div>
        </BoxMedium>
        <BoxSmall background={"linear-gradient(45deg, #ff00f6 -60%, #00ffcc, #46ff00 200%)"}>
          <div>
            <div className={[textStyles.text24, textStyles.dark, textStyles.bold].join(" ")}>Level up with Adobe Express.</div>
      ...
      <Container style={{ paddingInline: 0 }}>
        <BoxFull background={"linear-gradient(45deg, #ff00f6 0%, #00ffcc, #46ff00 200%)"}>
          <div className={[textStyles.text36, textStyles.light, textStyles.bold].join(" ")}>Work smarter with Adobe Acrobat Sign.</div>
          <div className={marginStyles.block2rem}></div>
          <div className={[textStyles.text20, textStyles.light].join(" ")}>
      ...
      <Container>
        <BoxSmall background={"linear-gradient(45deg, #ff00f6 -60%, #00ffcc, #46ff00 200%)"}>
          <div>
            ...
            <div className={[textStyles.text24, marginStyles.block1rem, textStyles.bold].join(" ")}>Work now works wherever.</div>
        ...
        <BoxSmall background={"linear-gradient(45deg, #ff00f6 -60%, #00ffcc, #46ff00 200%)"}>
          <div>
            ...
            <div className={[textStyles.text24, marginStyles.block1rem, textStyles.bold].join(" ")}>PDFs keep work flowing.</div>
            <div className={[textStyles.text16].join(" ")}>
      ...
      <Container>
        <BoxSmall background={"linear-gradient(45deg, #ff00f6 -60%, #00ffcc, #46ff00 200%)"}>
          <div>
            ...
            <div className={[textStyles.text24, marginStyles.block1rem].join(" ")}>End to end.</div>
            <div className={[textStyles.text16, marginStyles.block1rem].join(" ")}>
        ...
        <BoxSmall background={"linear-gradient(45deg, #ff00f6 -60%, #00ffcc, #46ff00 200%)"}>
          <div>
            ...
            <div className={[textStyles.text24, marginStyles.block1rem].join(" ")}>Today’s trends in focus.</div>
            <div className={[textStyles.text16, marginStyles.block1rem].join(" ")}>
