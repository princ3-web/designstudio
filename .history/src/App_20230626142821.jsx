    ...
    <div>
      ...
      <Container>
        <BoxFull background={background}>
          <div className={[Text.text36, Text.textLight].join(" ")}>Creative plans. Designed for you.</div>
      ...
      <Container>
        <BoxSmall background={"var(--orange-100)"}>
          <div>
            ...
            <div className={[Text.text24, Margin.block1rem].join(" ")}>Recolor your world.</div>
        ...
        <BoxSmall background={"linear-gradient(135deg ,#ff0069, #ff7f00)"}>
          <div>
            ...
            <div className={[Text.text18, Margin.block1rem].join(" ")} style={{ color: "var(--gray-100)" }}>
        ...
        <BoxSmall background={"var(--purple-100)"}>
          <div>
            <div className={[Text.text18, Text.bold, Text.underline].join(" ")}>Explore our creative apps</div>
            <div className={[Text.text14, Margin.block1rem].join(" ")}>Creative Cloud All Apps free trial</div>
            <div className={[Text.text14, Margin.block1rem].join(" ")}>See plans and pricing</div>
            <div className={[Text.text18, Text.bold, Text.underline].join(" ")}>See what you can do</div>
            <div className={[Text.text14, Margin.block1rem].join(" ")}>Photography</div>
            <div className={[Text.text14, Margin.block1rem].join(" ")}>Graphic design</div>
